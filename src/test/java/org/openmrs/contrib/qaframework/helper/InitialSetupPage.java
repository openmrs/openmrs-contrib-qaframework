...
public class InitialSetupPage extends Page {
	...
	public void waitForSetupToComplete() {
		new WebDriverWait(driver, Duration.ofSeconds(720L)).until(
		    ExpectedConditions.or(ExpectedConditions.urlContains("index.htm"), ExpectedConditions.urlContains("home.page")));
	}
