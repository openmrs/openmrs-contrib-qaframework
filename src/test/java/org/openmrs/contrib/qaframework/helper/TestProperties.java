...
/**
 * Exposes test properties. This class is typically used like this: TestProperties properties =
 * TestProperties.instance(); Properties are obtained using the following order of lookup: 1. Java
 * system property (System.getProperty). This allows for command line -D setting. 2. OS environment
 * variable (System.getenv). 3. test.properties file found on the classpath under
 * org/openmrs/uitestframework/ 4. The hard-wired defaults in this class. Also note that
 * test.properties can be "filled in" with properties from pom.xml by using ${}, e.g. in
 * test.properties: webapp.url=${webapp.url} in pom.xml: &lt;properties&gt;
 * &lt;webapp.url&gt;http://localhost:8080/openmrs&lt;/webapp.url&gt; &lt;/properties&gt;
 */
