...
public class AddPersonPage extends Page {
	...
	private static final By CREATE_PATIENT_BUTTON = By.cssSelector("#createPatient input[type=\"submit\"]");
	...
	public PersonFormPage createPerson() {
		clickOn(CREATE_PATIENT_BUTTON);
		return new PersonFormPage(this);
	}

	public void setPersonName(String personName) {
		setTextField(personName, PERSON_NAME_FIELD);
	}
