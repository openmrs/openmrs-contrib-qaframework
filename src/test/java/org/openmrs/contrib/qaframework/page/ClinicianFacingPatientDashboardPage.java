...
public class ClinicianFacingPatientDashboardPage extends Page {
	...
	public PatientVisitsDashboardPage enterDate() {
		...
		A: for (int j = 6; j > 0; j--) {
			for (int i = 7; i > 0; i--) {
				WebElement day = findElement(
				    By.xpath(String.format("//table[@class=' table-condensed']/tbody/tr[%s]/td[%s]", j, i)));
	...
	public String getPatientFamilyName() {
		String patientFamilyName = findElement(By.cssSelector(".patient-header .demographics .name .PersonName-familyName"))
		        .getText();
