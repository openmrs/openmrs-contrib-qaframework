...
public class AdmitExitInpatientTest extends ReferenceApplicationTestBase {
	...
	public void admitExitInpatientTest() {
		...
		patientVisitsDashboardPage = (PatientVisitsDashboardPage) patientVisitsDashboardPage
				.goToAdmitToInpatient().confirm(INPATIENT_WARD);
		assertThat(patientVisitsDashboardPage.getEncountersCount(), is(1));

		patientVisitsDashboardPage.goToExitFromInpatient().confirm(
				INPATIENT_WARD);
