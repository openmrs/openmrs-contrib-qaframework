...
public class DuplicatePatientRegisterTest extends ReferenceApplicationTestBase {
	...
	public void duplicatePatientRegisterTest() throws InterruptedException,
			ParseException {
		...
		assertThat(name,
				Matchers.is(patient.givenName + " " + patient.familyName));

		final String OLD_FORMAT = "d.MMM.yyyy";
		final String NEW_FORMAT = "dd.MMM.yyyy";

		String oldBirthDate = patient.birthDay + "."
				+ patient.birthMonth.substring(0, 3) + "." + patient.birthYear;
		String newBirthDate;
		...
		assertThat(
				info,
				Matchers.is(patient.gender + ", " + newBirthDate + ", "
