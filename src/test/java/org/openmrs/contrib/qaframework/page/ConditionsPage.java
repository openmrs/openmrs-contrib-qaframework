...
public class ConditionsPage extends Page {
	...
	private static final By CONFIRM_DELETE_CONDITION_BUTTON = By
			.cssSelector("#remove-condition-dialog > div.dialog-content > button.confirm.right");
	...
	public String getFirstConditionName() {
		try {
			waiter.until(ExpectedConditions
					.elementToBeClickable(FIRST_CONDITION_NAME));
