...
public class RunReportPage extends Page {
	...
	private static final By START_DATE_FIELD = By
			.cssSelector("#userEnteredParamstartDate");
	private static final By END_DATE_FIELD = By
			.cssSelector("#userEnteredParamendDate");
	private static final By REQUEST_REPORT_BUTTON = By
			.xpath("//*[@id=\"container\"]/div/table/tbody/tr/td[1]/fieldset/form/table[2]/tbody/tr[3]/td/input");
