...
public class RegistrationTest extends Steps {
    ...
    @And("User enters " + CucumberProperties.REGEX_UNDER_DOUBLE_QUOTES_STRING + " patient details")
    ...
    @Then("User's patient registration is " + CucumberProperties.REGEX_UNDER_DOUBLE_QUOTES_STRING)
