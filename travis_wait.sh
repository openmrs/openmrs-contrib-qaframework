...
do
  ...
  https://api.travis-ci.org/repos/openmrs/openmrs-contrib-qaframework);
  ...
  then
    ...
    echo "Please visit https://travis-ci.org/openmrs/openmrs-contrib-qaframework/builds/$build or see build $buildNumber at https://saucelabs.com/u/openmrs for details"
	echo "";
  fi
