...
public class LocationSensitiveApplicationTestBase
		extends
	...
	public void createTaggedLocation() {
		...
		locationUuid = new TestData.TestLocation(locationName, Arrays.asList(
				visit, login, transfer, admission)).create();
