...
public class ManageUserAccountPage extends Page {
	...
	private static final By SEARCH_USER = By
			.cssSelector("#list-accounts_filter input[type=text]");
	private static final By ADD_NEW_ACCOUNT = By
			.cssSelector("#content a[href='/openmrs/adminui/systemadmin/accounts/account.page']");
	private static final By FAMILY_NAME = By
			.cssSelector("#adminui-familyName-field");
	private static final By GIVEN_NAME = By
			.cssSelector("#adminui-givenName-field");
	private static final By GENDER_FEMALE = By
			.cssSelector("#adminui-gender-1-field");
	private static final By ADD_USER_ACCOUNT = By.id("adminui-addUserAccount");
	private static final By USER_NAME = By
			.cssSelector("#adminui-username-field");
	private static final By PRIVILEGE_LEVEL = By
			.cssSelector("#adminui-privilegeLevel-field");
	private static final By PASSWORD = By
			.cssSelector("#adminui-password-field");
	private static final By CONFIRM_PASSWORD = By
			.cssSelector("#adminui-confirmPassword-field");
	private static final By ADD_PROVIDER_ACCOUNT = By
			.id("adminui-addProviderAccount");
	private static final By IDENTIFIER = By
			.cssSelector("#adminui-identifier-field");
	private static final By PROVIDER_ROLE = By
			.cssSelector("#adminui-providerRole-field");
	private static final By EDIT_USER_ACCOUNT = By
			.cssSelector("i.icon-pencil.edit-action");
	private static final By ADMINISTER_SYSTEM = By
			.id("adminui-capabilities-Application: Administers System");
	private static final By CONFIGURE_FORMS = By
			.id("adminui-capabilities-Application: Configures Forms");
	private static final By CAPTURE_VITALS = By
			.id("adminui-capabilities-Application: Enters Vitals");
	private static final By RECORD_ALLERGIES = By
			.id("adminui-capabilities-Application: Records Allergies");
	private static final By CONFIGURE_METADATA = By
			.id("adminui-capabilities-Application: Configures Metadata");
	private static final By SUPER_USER_PRIVILEGES = By
			.id("adminui-capabilities-Application: Has Super User Privileges");
	private static final By REGISTER_PATIENT = By
			.id("adminui-capabilities-Application: Registers Patients");
	private static final By SCHEDULE_APPOINTMENTS = By
			.id("adminui-capabilities-Application: Schedules And Overbooks Appointments");
	private static final By PATIENT_SUMMARY = By
			.id("adminui-capabilities-Application: Uses Patient Summary");
	...
	public boolean isDataCorrect(List<String> validationErrors) {
		return !validationErrors
				.contains("Validation errors found Failed to save account details");
	}
}
