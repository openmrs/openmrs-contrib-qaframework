...
public class ManageProviderSchedulesPage extends Page {
	...
	private static final By LOCATION_IN_BLOCK = By.cssSelector("#select-location select");
	...
	private static final By MIN_HOUR_VALUE_FIELD = By.cssSelector("#start-time table tbody td:nth-child(1) input");
	private static final By MAX_HOUR_VALUE_FIELD = By.cssSelector("#end-time table tbody td:nth-child(1) input");
	private static final By MIN_MINUTES_VALUE_FIELD = By.cssSelector("#start-time table tbody td:nth-child(3) input");
	private static final By MAX_MINUTES_VALUE_FIELD = By.cssSelector("#end-time table tbody td:nth-child(3) input");
	...
	/**
	 * Clicks on the next available weekday. We use this because the default for
	 * the appointment's module is to only show appointments for weekdays.
	 */
