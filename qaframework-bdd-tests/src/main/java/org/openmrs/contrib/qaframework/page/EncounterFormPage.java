...
public class EncounterFormPage extends Page {
	...
	private static final By ENCOUNTER_DATE_TIME_FIELD= By.cssSelector("#content form div:nth-child(1) table tbody tr:nth-child(3) td input[type=text]");
	...
	private static final By CLOSE_CALENDER_BUTTON = By.cssSelector("#ui-datepicker-div > div.ui-datepicker-buttonpane.ui-widget-content > button.ui-datepicker-close.ui-state-default.ui-priority-primary.ui-corner-all");
