...
public class FormTest extends TestBase {
    ...
    private static final String FORM_NAME = "newFormTest1";
    private static final String FORM_DESCRIPTION = "description of new form";
    ...
    public void initiateFormPresence() throws InterruptedException {
        ...
        if (manageHtmlFormsPage.getElementsIfExisting(By.xpath("//*[contains(text(), '" + FORM_NAME + "')]")).isEmpty()) {
        	manageHtmlFormsPage.clickOnNewHtmlForm();
        	htmlFormsPage.createNewFormTest(FORM_NAME, FORM_DESCRIPTION, VERSION);
        }
        homePage.go();
