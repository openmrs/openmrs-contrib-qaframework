...
public class RunTest {
	...
	public class HOOK {
		...
		public static final String ADD_USER_AND_ROLES_TO_USER  = "@user";
		...
		public static final String SELENIUM_ADD_USER_AND_ROLES_TO_USER  = SELENIUM + " and " + ADD_USER_AND_ROLES_TO_USER;
