...
public class VisitTypePage extends Page {
	...
	private static final By SAVE_VISIT_TYPE = By
			.cssSelector("#content input[name=\"save\"]");
	private static final By DELETE_VISIT_TYPE = By
			.cssSelector("#purge input[name=\"purge\"]");
	private static final By RETIRE_VISIT_TYPE = By
			.cssSelector("#content input[name=\"retire\"]");
	private static final By NAME_TEXT_FIELD = By
			.cssSelector("#content input[name='name']");
	private static final By DESCRIPTION_TEXT_FIELD = By
			.cssSelector("#content textarea[name='description']");
	private static final By RETIRE_REASON_TEXT_FIELD = By
			.cssSelector("#content input[name=\"retireReason\"]");
