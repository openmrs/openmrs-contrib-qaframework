...
public class AddEditAppointmentBlockTest extends ManageProviderSchedulesTest {
	...
	public void addEditAppointmentBlockTest() throws Exception {
		/*
		 * The logic behind the text is: create an appointment and assert that
		 * exists change the service and assert that it has been changed search
		 * the newly created service delete the appointment
		 */
