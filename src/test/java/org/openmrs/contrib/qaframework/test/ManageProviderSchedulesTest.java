...
public class ManageProviderSchedulesTest extends ReferenceApplicationTestBase {
	...
	public void setUp() throws Exception {
		 ...
		 * create one locationName = "Location-"+TestData.randomSuffix(); We
		 * must be sure that the location has been created, the test will fail
		 * otherwise locationUuid = TestData.createLocation(locationName);
