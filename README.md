...
[![RefApp 2.x Add User and Add Roles To User](https://github.com/openmrs/openmrs-contrib-qaframework/actions/workflows/refapp-2x-add-user-and-add-roles-to-user.yml/badge.svg)](https://github.com/openmrs/openmrs-contrib-qaframework/actions/workflows/refapp-2x-add-user-and-add-roles-to-user.yml)
