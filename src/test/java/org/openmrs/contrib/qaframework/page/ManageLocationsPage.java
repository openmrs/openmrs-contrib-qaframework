...
public class ManageLocationsPage extends Page {
	...
	private static final By ADD_EDIT_LOCATION = By
	        .cssSelector("#content a[href='/openmrs/" + AddEditLocationPage.PAGE_URL + "']");
	...
	public void purgeLocation(String locationName) {
		clickOn(By.xpath("//tr/td[preceding-sibling::td[contains(text(), '" + locationName
		        + "')]]/i[@class='icon-trash delete-action']"));
	...
	public void retireLocation(String locationName) {
		clickOn(By.xpath("//tr/td[preceding-sibling::td[contains(text(), '" + locationName
		        + "')]]/i[@class='icon-remove delete-action']"));
	...
	public void assertRetired(String locationName) {
		try {
			findElement(By.xpath("//tr/td[preceding-sibling::td[contains(text(), '" + locationName
