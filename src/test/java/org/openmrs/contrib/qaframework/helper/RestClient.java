...
public class RestClient {
	...
	public static String generatePatientIdentifier(String source) {
		...
		WebTarget target = client.target(getWebAppUrl()).path("/module/idgen/generateIdentifier.form")
		        .queryParam("source", source).queryParam("username", getUsername()).queryParam("password", getPassword());
